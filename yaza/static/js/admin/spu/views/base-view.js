define(['jquery', 'dispatcher', 'admin/spu/context', 'underscore', 'backbone', 'handlebars', 'text!templates/admin/spu/view.hbs', 'text!templates/admin/spu/entry.hbs', 'spectrum', 'jquery-file-upload', 'underscore.string', 'js-url', "ekko-lightbox"], function ($, dispatcher, context, _, Backbone, handlebars, template, entryTemplate) {
